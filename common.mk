...
ifndef FREAK_BUILD_TYPE
    FREAK_BUILD_TYPE := UNOFFICIAL
    PLATFORM_VERSION_CODENAME := UNOFFICIAL
endif 

ifeq ($(FREAK_BUILD_TYPE), OFFICIAL)
PRODUCT_PACKAGES += \
	AEXOTA
endif

FREAK_MOD_VERSION := Freak-$(FREAK_VERSION)-$(shell date -u +%Y%m%d-%H%M)-$(FREAK_BUILD_TYPE)

PRODUCT_PROPERTY_OVERRIDES += \
  ro.freak.version=$(FREAK_VERSION) \
  ro.freak.releasetype=$(FREAK_BUILD_TYPE) \
  ro.modversion=$(FREAK_MOD_VERSION)
  
FREAK_DISPLAY_VERSION := Freak-$(FREAK_VERSION)-$(FREAK_BUILD_TYPE)

PRODUCT_PROPERTY_OVERRIDES += \
  ro.freak.display.version=$(FREAK_DISPLAY_VERSION)
